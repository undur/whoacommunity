...
/**
 * Class _SlackMessage was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _SlackMessage extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<SlackMessage> SELF = PropertyFactory.createSelf(SlackMessage.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "SlackMessage", Integer.class);
    ...
    public static final EntityProperty<SlackChannel> CHANNEL = PropertyFactory.createEntity("channel", SlackChannel.class);
    public static final EntityProperty<SlackUser> USER = PropertyFactory.createEntity("user", SlackUser.class);
    ...
    public SlackChannel channel() {
        return (SlackChannel)readProperty("channel");
    }
    ...
    public SlackUser user() {
        return (SlackUser)readProperty("user");
    }
