...
import whoacommunity.components.WCGuideParsleyPage;
...
public class Application extends NGApplication {
	...
	public Routes routes() {
		return Routes
				...
				.map( "/guide/parsley-template-syntax", WCGuideParsleyPage.class )
	...
	public NGActionResults sitemap( NGRequest request ) {
		...
		for( String path : List.of( "/", "/writing", "/projects", "/guides", "/dev-feed", "/videos", "/deployment-config", "/deployment-apache-modulo", "/deployment-apache-mod-webobjects", "/guide/wonder-slim-development", "/guide/building-with-vermilingua", "/guide/parsley-template-syntax" ) ) {
